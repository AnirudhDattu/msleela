  ...
  return (
    <div className="bg-black">
      <div className="bg-black pt-20">
        ...
        <div className="relative flex items-center py-4 ml-32 mt-10  ">
          {/* Small rectangle */}
          <div
            className="w-[9px] h-[59px] bg-[#C19162]"
            style={{ position: "relative" }}
        ...
        <div className="ml-20 mr-32">
          <p className="text-white mx-32 mt-8 tracking-widest">
            ...
            feedback improved navigation and the clarity of the website&apos;s
            key features. This continuous loop of feedback allowed me to refine
        ...
        <div className="ml-20 mr-32 pb-10">
          <ul className="text-white flex flex-col gap-4 list-disc list-outside mx-32 mt-8 tracking-widest">
            ...
            <li>
              Minimal UX Process: Due to the time restrictions, I focused more
              on the UI elements, with limited opportunity to conduct user
              research or in-depth usability testing. However, the clean,
              intuitive design mitigated potential UX issues.
            </li>
          </ul>
        </div>
