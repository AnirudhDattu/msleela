      ...
      <div className="w-full md:w-2/5">
        ...
        <div className="text-white w-full md:w-2/3 lg:max-w-[610px] pt-10 pl-44 pb-20">
          ...
          <p className="text-lg mb-8 tracking-widest leading-8 font-sansation opacity-80">
            ...
            you’d expect from{" "}
            <span className="text-[#BF81F0]">industry work</span>, with a focus
            on delivering real, tangible results. These experiences have honed
            my ability to empathize with users, iterate on designs, and create{" "}
      ...
      <div>
        ...
        <div className="text-white w-full lg:max-w-[560px] mt-24">
          <p className="text-lg mb-8 tracking-widest leading-8 font-sansation opacity-80">
            ...
            turning a sunset into a palette or finding the perfect layout in the
            structure of everyday life, I believe that the best designs come
            from a deep understanding of the world around us. My work reflects
            this—every project has a story, a sense of purpose, and a personal
            touch. I don’t just create for users, I create with them in mind,
            designing experiences that feel welcoming, and real. For me, design
            is all about turning those small, meaningful experiences into
        ...
        <div className="text-white w-full lg:max-w-[560px] mt-32">
          ...
          <p className="text-lg mb-8 tracking-widest leading-8 font-sansation opacity-80">
            ...
            emotion, whether it's through subtle interactions, thoughtful color
            choices, or a layout that just feels right. My goal? To create
            digital experiences that resonate with users on a deeper level,
